                            ...
                            @if (session()->has('cart'))
                                                    ...
                                                    @if (!@empty($cart['discount']))
                                                        @foreach ($cart['discount'] as $discounts)
                                                            ...
                                                            <small class="option status_order discount"
                                                                idx="{{ $discounts['id'] }}"
                                                                dis="{{ $discounts['percent'] }}">Discount
                                                                {{ $discounts['percent'] }}% -
                                                                {{ $discounts['nominal'] }}</small>
                                                        @endforeach
                                                    @endif
                                ...
                                <div class="footer-sub-total">
                                    <div class="total">
                                        ...
                                        <div class="txt-price-total subtotal" data-subT=""
                                    ...
                                    @foreach ($taxs as $tax)
                                        ...
                                        <div class="total taxes" idx="{{ $tax->id }}">
                                            <div class="txt-total service-change">{{ $tax->nama }} <p
...
@section('script')
    ...
    <script>
        ...
        channel.bind('orders-event', function(data) {
            ...
            // alert('Check Order Now\nKode: ' + data.kode_pemesanan + '\nNomor Meja: ' + data.no_meja);
            ...
            if ($iframe.length && $iframe[0].contentWindow) {
                ...
                $(iframeContentWindow.document).ready(function() {
                    ...
                    if ($notifAudio.length) {
                        ...
                        console.log('Tipe objek notifAudio (dari dalam iframe):', typeof notifAudio,
                            notifAudio);
                        ...
                        if (typeof notifAudio.play === 'function') {
                            ...
                            console.error(
                                "Kesalahan: notifAudio.play BUKANLAH fungsi. Elemen di dalam iframe mungkin bukan audio valid."
                                );
                        }
                    } else {
                        console.error(
                            "❌ Elemen audio dengan class 'audioPlace' tidak ditemukan di dalam iframe.");
                    }
                });
            } else {
