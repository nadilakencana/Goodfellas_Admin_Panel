<div class="col-12 px-0 col-sm-8 col-md-8 col-lg-8 fixed-top mx-auto" id="mainNavbar">
    <div class="d-flex gap-3 justify-content-between align-items-center nav-fixed p-3  ">
        ...
        <div class="search-menu w-100 relative">
            <input type="text" class="form-control" placeholder="Search your menu" id="search_menu">
            <img class="icon-search" src="{{ asset('asset/assets/image/icon _search_.png') }}" alt=""
                width="20" height="20">
            <div id="search-results-dropdown" class="search-results-container" ></div>
