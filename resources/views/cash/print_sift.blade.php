        ...
        <div class="data-detial">
            <div class="header mt-3">
                ...
                <div class="dt-header d-flex justify-content-between">
                    ...
                    <p class="text-detail date" date="{{ $sift->start_time }}">{{ $sift->start_time }}-{{ date("H:i",
                        strtotime($sift->created_at)) }}
                    </p>
                </div>
                <div class="dt-header d-flex justify-content-between">
            ...
            @php
            $total_EDC = ($BCA + $RefundTotalBCA) + ($mandiri + $RefundTotalMandiri);
